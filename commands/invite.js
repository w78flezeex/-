...
module.exports.run = async (client, message, args) => {
    ...
    .addComponents(
        ...
        .setStyle(ButtonStyle.Link)
        .setURL("https://discord.gg/ZVzuq4kuu3"),
    )
    ...
    .setDescription(`Invite ${client.user} заходите на свой сервер сегодня и наслаждайтесь беспроигрышными розыгрышами с расширенными функциями!`)
    .setColor('#2F3136')
    .setTimestamp()
    .setFooter({
